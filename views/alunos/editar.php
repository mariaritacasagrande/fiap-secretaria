...
<body class="bg-light">
    ...
    <div class="container-fluid px-4">
        ...
        <form method="POST" action="index.php?page=alunos&action=atualizar"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text"
                        class="form-control <?= (!empty($erro) && stripos($erro, 'cpf') !== false) ? 'is-invalid' : '' ?>"
                        id="cpf" name="cpf" required value="<?= htmlspecialchars($aluno['cpf']) ?>">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="email"
                        class="form-control <?= (!empty($erro) && stripos($erro, 'email') !== false) ? 'is-invalid' : '' ?>"
                        id="email" name="email" required value="<?= htmlspecialchars($aluno['email']) ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input type="password"
                        ...
                        id="senha" name="senha" pattern="(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*\W).{8,}">
                    <div class="form-text">
                        Preencha apenas se desejar alterar a senha. Deve conter no mínimo 8 caracteres, incluindo letra
