                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="d-flex flex-wrap justify-content-center gap-2">
                                        <a href="index.php?page=turmas&action=editar&id=<?= $turma['id'] ?>"
                                            class="btn btn-warning btn-sm">Editar</a>
                                        <a href="index.php?page=turmas&action=excluir&id=<?= $turma['id'] ?>"
                                            class="btn btn-danger btn-sm"
                                            onclick="return confirm('Excluir esta turma?')">Excluir</a>
                                        <a href="index.php?page=matriculas&action=listar&turma_id=<?= $turma['id'] ?>"
                                            class="btn btn-info btn-sm">Ver Alunos</a>
                                    </div>
                                </td>
                            </tr>
                        <?php endforeach ?>
